...
class PMFDAirspeedIndicator extends HTMLElement {
    constructor() {
        super();
        this.trendValue = 0;
        this.redBegin = 0;
    ...
    connectedCallback() {
        ...
        this.root.setAttribute("viewBox", "0 -50 250 1250");
        ...
        }
        {
            ...
            background.setAttribute("width", "200");
            background.setAttribute("height", "1150");
            background.setAttribute("fill", "#1a1d21");
            ...
            this.centerSvg.setAttribute("height", "1150");
            this.centerSvg.setAttribute("viewBox", "0 0 250 1150");
            this.root.appendChild(this.centerSvg);
            {
                ...
                this.centerSvg.appendChild(this.centerGroup);
                {
                    ...
                    if (this.getAttribute("NoColor") != "True") {
                        ...
                        dashSvg.setAttribute("height", "1150");
                        dashSvg.setAttribute("viewBox", "0 0 25 1150");
                        ...
                        startBg.setAttribute("height", "1150");
                ...
                baseCursorSvg.setAttribute("y", "525");
                ...
                rotatingCursorSvg.setAttribute("y", "503");
        ...
        }
        {
            ...
            this.bottomBackground.setAttribute("y", "1150");
            ...
            this.maText.setAttribute("y", "1188");
...
customElements.define('glasscockpit-pmfd-airspeed-indicator', PMFDAirspeedIndicator);
